...
export class HeroService {
  ...
  //cette fonction etait pour utilisé l'asynchrone sans api a proprement parler ont le remplace donc
  ...
  searchHeroes(term: string):Observable<Hero[]>
  {
    ...
    return this.httpClient.get<Hero[]>(`${this.heroesUrl}/?name=${term}`).pipe(
      tap(x => x.length ? this.log(`found heroes matching "${term}"`) : this.log(`no heroes matching`)),
